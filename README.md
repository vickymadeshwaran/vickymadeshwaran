...
- **Tools & Technologies:** Android Studio, MQTT, Elastic search, MySQL, MSSQL, Linux-based server management
- **IoT:** Device configuration, connection, and live parameter display
- **PLCs:** Allen Bradley, Innovance, Siemens, Mitsubishi Motors
